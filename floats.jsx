  ...
  return (
    <div className="floats">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "flex-end" }}>
        <button className="float-btn bot" onClick={onToggleChat} aria-label={chatOpen ? "Cerrar chat" : "Abrir chat"} title="Asistente Umbría">
          {chatOpen ? (
            /* × close */
        ...
        <a className="float-btn wa" href="https://wa.me/56958335416" target="_blank" rel="noopener" aria-label="WhatsApp">
